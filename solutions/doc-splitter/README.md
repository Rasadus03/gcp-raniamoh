...
This repository contains several a Jupyter notebook for using the Procurement spliter processor and invoice parser processor.
...
1. Create  Identify which form type or utility you would like to run through a processor.
